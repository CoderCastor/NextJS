...
function page() {
  ...
  return (
    <div className='h-screen w-screen flex flex-col justify-center items-center p-10 bg-zinc-900 gap-5'>
      ...
      }} className='bg-zinc-900 rounded-2xl px-2 py-2' type="text" name="username" placeholder='username' id="" />
      <input onChange={e => {
        setPassword(e.target.value)
      }} className='bg-zinc-900 rounded-2xl px-2 py-2' type="password" name="password" placeholder='password' id="" />
      <button onClick={()=>{
